...
# Heading
w2 = Label(root, justify=LEFT, text="disease-prediction", fg="white", bg="grey")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="Disease Prediction Project By AYUSH TRIPATHI", fg="red", bg="grey")
